      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 gap-4">
          {challenges.map((c, idx) => (
            <div key={c.challengeId ? `${c.challengeId}-${idx}` : `challenge-${idx}`} className="bg-card p-6 rounded-3xl card-shadow flex items-center justify-between gap-6 group hover:border-primary/30 border-2 border-transparent transition-all">
